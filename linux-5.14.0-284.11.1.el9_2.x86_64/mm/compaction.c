 ...
 */
//把隔离成功的page移动到cc->migratepages链表 
static int
...
isolate_success:
        //把内存zone中隔离成功的page移动到cc->migratepages链表
...
static void isolate_freepages(struct compact_control *cc)
{
	...
	for (; block_start_pfn >= low_pfn;
        ...
        //这里隔离page并移动到freelist即cc->freepages链表
...
compact_zone(struct compact_control *cc, struct capture_control *capc)
{
	...
	while ((ret = compact_finished(cc)) == COMPACT_CONTINUE) {
        ...
        //isolate_migratepages()里把内存zone中隔离成功的page移动到cc->migratepages链表
        ...
        //这里遍历cc->migratepages链表上的page，进行内存迁移
