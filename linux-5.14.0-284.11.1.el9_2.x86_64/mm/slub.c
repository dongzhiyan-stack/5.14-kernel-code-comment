...
static bool shuffle_freelist(struct kmem_cache *s, struct slab *slab)
{
	...
	//crash流程 get_random_int->get_random_u32->_get_random_bytes->crng_make_state->crng_reseed->drain_entropy->extract_entropy->
	//blake2s_final->__blake2s_final->blake2s_compress->kernel_fpu_begin->irq_fpu_usable
