...
__used __section("__versions") = {
	...
	{ 0x69ee2220, "linear_range_get_selector_high" },
	{ 0x18935f12, "kunit_unary_assert_format" },
	{ 0xc5777fca, "linear_range_get_selector_low_array" },
	{ 0xd0da656b, "__stack_chk_fail" },
	{ 0x5b8239ca, "__x86_return_thunk" },
	{ 0xc2faf742, "kunit_do_assertion" },
	{ 0xee54a789, "kunit_binary_assert_format" },
	{ 0x932c8d7a, "linear_range_get_value_array" },
};

MODULE_INFO(depends, "kunit,linear_ranges");


MODULE_INFO(srcversion, "7CDB5AAC5CD57BFAC82F9EF");
